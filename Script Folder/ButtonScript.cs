...
public class ButtonScript : MonoBehaviour
{
    ...
    public GameObject SettingPopUp; // 세팅 팝업
    ...
    void Start()
    {
        ...
        for(int i = 0; i < 4; i++)
        {
            if (GameManger.GetComponent<InforMation>().PlayerItem[i] != null)
            {
                WearItemObject[i].GetComponent<Image>().sprite = GameManger.GetComponent<InforMation>().PlayerItem[i];
                color = WearItemObject[i].GetComponent<Image>().color;
                color.a = 1f;
                WearItemObject[i].GetComponent<Image>().color = color;
            }
        }
        ButtonClick.volume = GameManger.GetComponent<InforMation>().EffectSoundValue / 100;
    }
    ...
    public void ItemStatetext(int index, int Item)
    {
        ...
        {
            RandomItemname[index].text = "Damage UP Potion\n" + "모든 무기의 데미지 + 5\n" + "남은 구매 수 : " + (5 - GameManger.GetComponent<InforMation>().ItemCount[0]).ToString();
            BuyButtonprice[index].text = GameManger.GetComponent<InforMation>().Itemprice[Item].ToString();
            RandomItemprice[index] = GameManger.GetComponent<InforMation>().Itemprice[Item];
        }
        else if (Item == 2)
        {
            RandomItemname[index].text = "Attack Speed UP Potion\n" + "모든 무기의 공격 속도 + 0.1\n" + "남은 구매 수 : " + (5 - GameManger.GetComponent<InforMation>().ItemCount[1]).ToString();
            BuyButtonprice[index].text = GameManger.GetComponent<InforMation>().Itemprice[Item].ToString();
            RandomItemprice[index] = GameManger.GetComponent<InforMation>().Itemprice[Item];
        }
        else if (Item == 3)
        {
            RandomItemname[index].text = "Speed UP Potion\n" + "플레이어 이동 속도 + 0.1\n" + "남은 구매 수 : " + (5 - GameManger.GetComponent<InforMation>().ItemCount[2]).ToString();
            BuyButtonprice[index].text = GameManger.GetComponent<InforMation>().Itemprice[Item].ToString();
            RandomItemprice[index] = GameManger.GetComponent<InforMation>().Itemprice[Item];
        }
        else if (Item == 4)
    ...
    public void ItemStateSetting(int index)
    {
        for(int i = 0; i < 4; i++)
        {
            if(WearItemObject[index].GetComponent<Image>().sprite.name == RandomItemSprite[i].name)
            {
                ...
                {
                    for (int j = 0; j < 6; j++) GameManger.GetComponent<InforMation>().WearWeapondamage[j] += 5;
                    GameManger.GetComponent<InforMation>().ItemCount[0]++;
                }
                else if (i == 2)
                {
                    for (int j = 0; j < 6; j++) GameManger.GetComponent<InforMation>().WearWeaponspeed[j] += 0.1f;
                    GameManger.GetComponent<InforMation>().ItemCount[1]++;
                }
                else if (i == 3)
                {
                    GameManger.GetComponent<InforMation>().PlayerSpeed += 0.1f;
                    GameManger.GetComponent<InforMation>().ItemCount[2]++;
                }
                break;
            }
        }
    ...
    public void BuyItem()
    {
        ...
        if(GameManger.GetComponent<InforMation>().Coin >= RandomItemprice[Buttonnum])
        {
                ...
                if (count == 6)
                {
                    ...
                    for (int i = 0; i < 6; i++)
                    {
                        if (WearWeaponObject[i].GetComponent<Image>().sprite == RandomItemImageObject[Buttonnum].GetComponent<Image>().sprite && GameManger.GetComponent<InforMation>().WeaponGrade[i] == Grade && GameManger.GetComponent<InforMation>().WeaponGrade[i] < 3)
                        {
                            ...
                            cointext.text = GameManger.GetComponent<InforMation>().Coin.ToString();
                            EventSystem.current.currentSelectedGameObject.GetComponent<Button>().interactable = false;
                            if(GameManger.GetComponent<InforMation>().weaponname[i] == 0)
                            {
                                if (GameManger.GetComponent<InforMation>().PlayerJob == 0) GameManger.GetComponent<InforMation>().WearWeapondamage[i] -= 10;
                            ...
                            else if (GameManger.GetComponent<InforMation>().weaponname[i] == 1)
                            {
                                if (GameManger.GetComponent<InforMation>().PlayerJob == 0) GameManger.GetComponent<InforMation>().WearWeapondamage[i] -= 10;
                            ...
                            else if (GameManger.GetComponent<InforMation>().weaponname[i] == 2)
                            {
                                if (GameManger.GetComponent<InforMation>().PlayerJob == 0) GameManger.GetComponent<InforMation>().WearWeapondamage[i] -= 10;
                            ...
                            else if (GameManger.GetComponent<InforMation>().weaponname[i] == 3)
                            {
                                if (GameManger.GetComponent<InforMation>().PlayerJob == 0) GameManger.GetComponent<InforMation>().WearWeapondamage[i] -= 10;
                            ...
                            else if (GameManger.GetComponent<InforMation>().weaponname[i] == 4)
                            {
                                if (GameManger.GetComponent<InforMation>().PlayerJob == 1) GameManger.GetComponent<InforMation>().WearWeapondamage[i] -= 10;
                            ...
                            else if (GameManger.GetComponent<InforMation>().weaponname[i] == 5)
                            {
                                if (GameManger.GetComponent<InforMation>().PlayerJob == 1) GameManger.GetComponent<InforMation>().WearWeapondamage[i] -= 10;
                            ...
                            else if (GameManger.GetComponent<InforMation>().weaponname[i] == 6)
                            {
                                if (GameManger.GetComponent<InforMation>().PlayerJob == 1) GameManger.GetComponent<InforMation>().WearWeapondamage[i] -= 10;
                            ...
                            else if (GameManger.GetComponent<InforMation>().weaponname[i] == 7)
                            {
                                if (GameManger.GetComponent<InforMation>().PlayerJob == 1) GameManger.GetComponent<InforMation>().WearWeapondamage[i] -= 10;
                            ...
                            else if (GameManger.GetComponent<InforMation>().weaponname[i] == 8)
                            {
                                if (GameManger.GetComponent<InforMation>().PlayerJob == 2) GameManger.GetComponent<InforMation>().WearWeapondamage[i] -= 10;
                            ...
                            else if (GameManger.GetComponent<InforMation>().weaponname[i] == 9)
                            {
                                if (GameManger.GetComponent<InforMation>().PlayerJob == 2) GameManger.GetComponent<InforMation>().WearWeapondamage[i] -= 10;
                            ...
                            else if (GameManger.GetComponent<InforMation>().weaponname[i] == 10)
                            {
                                if (GameManger.GetComponent<InforMation>().PlayerJob == 2) GameManger.GetComponent<InforMation>().WearWeapondamage[i] -= 10;
                            ...
                            else if (GameManger.GetComponent<InforMation>().weaponname[i] == 11)
                            {
                                if (GameManger.GetComponent<InforMation>().PlayerJob == 2) GameManger.GetComponent<InforMation>().WearWeapondamage[i] -= 10;
            ...
            else if (WeaponOrItem[Buttonnum] == "Item")
            {
                ...
                else if(RandomItemImageObject[Buttonnum].GetComponent<Image>().sprite.name == "#1 - Transparent Icons_131")
                {
                    EventSystem.current.currentSelectedGameObject.GetComponent<Button>().interactable = false;
                    GameManger.GetComponent<InforMation>().Coin -= RandomItemprice[Buttonnum];
                    cointext.text = GameManger.GetComponent<InforMation>().Coin.ToString();
                    for (int i = 0; i < 4; i++)
                    {
                        if (WearItemObject[i].GetComponent<Image>().sprite == null)
                        {
                            ...
                            GameManger.GetComponent<InforMation>().PlayerItem[i] = RandomItemImageObject[Buttonnum].GetComponent<Image>().sprite;
                            color = WearItemObject[i].GetComponent<Image>().color;
                            color.a = 1f;
                            WearItemObject[i].GetComponent<Image>().color = color;
                            ItemStateSetting(i);
                ...
                else if (RandomItemImageObject[Buttonnum].GetComponent<Image>().sprite.name == "#1 - Transparent Icons_133" && GameManger.GetComponent<InforMation>().ItemCount[0] < 5)
                {
                    EventSystem.current.currentSelectedGameObject.GetComponent<Button>().interactable = false;
                    GameManger.GetComponent<InforMation>().Coin -= RandomItemprice[Buttonnum];
                    cointext.text = GameManger.GetComponent<InforMation>().Coin.ToString();
                ...
                else if (RandomItemImageObject[Buttonnum].GetComponent<Image>().sprite.name == "#1 - Transparent Icons_134" && GameManger.GetComponent<InforMation>().ItemCount[1] < 5)
                {
                    EventSystem.current.currentSelectedGameObject.GetComponent<Button>().interactable = false;
                    GameManger.GetComponent<InforMation>().Coin -= RandomItemprice[Buttonnum];
                    cointext.text = GameManger.GetComponent<InforMation>().Coin.ToString();
                ...
                else if (RandomItemImageObject[Buttonnum].GetComponent<Image>().sprite.name == "#1 - Transparent Icons_132" && GameManger.GetComponent<InforMation>().ItemCount[2] < 5)
                {
                    EventSystem.current.currentSelectedGameObject.GetComponent<Button>().interactable = false;
                    GameManger.GetComponent<InforMation>().Coin -= RandomItemprice[Buttonnum];
                    cointext.text = GameManger.GetComponent<InforMation>().Coin.ToString();
    ...
    {
        GameManger.GetComponent<InforMation>().Coin += sellcoin;
        ButtonClick.PlayOneShot(CoinSound);//근접
    ...
    public void Weaponedit()
    {
        ...
        for (int i = 0; i < 6; i++)
        {
            if(i != num)
            {
                if(WearWeaponObject[i].GetComponent<Image>().sprite == WearWeaponObject[num].GetComponent<Image>().sprite && GameManger.GetComponent<InforMation>().WeaponGrade[num] < 3 && GameManger.GetComponent<InforMation>().WeaponGrade[i] == GameManger.GetComponent<InforMation>().WeaponGrade[num])
                {
    ...
    public void wearweapon()
    {
        ...
        if (WearWeaponObject[num].GetComponent<Image>().sprite != null)
        {
            ...
            sellcoin = (int)Mathf.Ceil(GameManger.GetComponent<InforMation>().WearWeaponPrice[num] / 2);
            WeaponPopUp.gameObject.transform.GetChild(4).GetChild(1).GetComponent<Text>().text = "+" + sellcoin.ToString();
